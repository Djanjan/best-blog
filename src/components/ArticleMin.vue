    ...
    <div>
        <v-card class="ma-5 mb-auto">
            <v-card class="text-center v-card--offset ml-2"
                ...
                <h2 class="pt-2 mx-3">{{article.created.split(' ')[0].split('-')[2]}}</h2>
                <div class="font-weight-light mx-2" style="font-size: 12px;">january</div>
                <span class="font-weight-light" style="font-size: 12px;">{{article.created.split('-')[0]}}</span>
            </v-card>
        ...
        >
          ...
          >
            ...
            <v-fade-transition>
              ...
              >
                <v-btn icon large
                  @click.stop="openArticle(article.id)"><v-icon>mdi-application</v-icon></v-btn>
              </v-overlay>
            </v-fade-transition>
          </v-img>
                    </v-hover>
